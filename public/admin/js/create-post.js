...
createImageUrl.addEventListener('change', () => { disableInput(createImageUrl, createImageFile) })
createImageFile.addEventListener('change', () => { disableInput(createImageFile, createImageUrl) })